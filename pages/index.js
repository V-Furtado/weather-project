  ...
  if (loading) {
    ...
    return (
      <div >
        ...
        {/* Search Form */}
        <div className="relative flex flex-col justify-between items-center max-w-[500px] w-full m-auto pt-3 text-white z-10">
          <h1 className="p-1 text-2xl font-bold text-yellow-100">
            View temperature for any city globally.
          </h1>
          <form
            onSubmit={fetchWeather}
            className="flex items-center justify-between p-3 m-auto text-white bg-transparent border border-gray-200 form-horizontal rounded-3xl"
          >
            <div>
              <input
